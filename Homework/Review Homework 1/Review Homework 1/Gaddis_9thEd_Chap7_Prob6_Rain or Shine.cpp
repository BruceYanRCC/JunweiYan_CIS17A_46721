...
/* 
 * File:   Gaddis_9thEd_Chap7_Prob6_Rain or Shine.cpp
 * Author: Junwei Yan
 *
 * Created on 2020年6月29日, 下午3:15
 */
...
string stats(char data[][DAYS],char stat[][MONTHS]){
    ...
    if(stat[1][2]==stat[0][2]&&stat[1][2]>stat[2][2])wchMnth="JUNE and JULY";
    if(stat[1][2]>stat[0][2]&&stat[1][2]==stat[2][2])wchMnth="JULY and AUGUST";
    if(stat[2][2]>stat[1][2]&&stat[2][2]==stat[0][2])wchMnth="JUNE and AUGUST";
    if(stat[2][2]==stat[1][2]&&stat[2][2]==stat[0][2])wchMnth="JUNE, JULY and AUGUST";
    return wchMnth;
}
